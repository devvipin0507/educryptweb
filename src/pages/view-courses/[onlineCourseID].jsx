...
const OnlineCourse = ({onlineCourseID}) => {
  ...
  useEffect(() => {
    ...
    if (onlineCourse_ID) {
      // window.scrollTo(0, 0);
      fetchCourseDetail(onlineCourse_ID.slice(onlineCourse_ID.indexOf(':') +1, onlineCourse_ID.length));
      setId(onlineCourse_ID.slice(onlineCourse_ID.indexOf(':') +1, onlineCourse_ID.length))
  ...
  return (
    <>
      ...
      <div className="container-fluid p-0 mt-5">
        <div 
          className={
            titleName && (titleName == "Bookstore" || titleName == "e-BOOK" || titleName == "Books" || titleName.startsWith("Boo"))
        ...
        >
          ...
          >
            ...
            {titleName &&
              (titleName == "Bookstore" || titleName == "e-BOOK" || titleName == "Books" || titleName.startsWith("Boo")) ? (
                <img
