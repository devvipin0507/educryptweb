...
const PurchaseHistory = () => {
  ...
  const handleInstallments = async (code) => {
    try {
      ...
      const response_pendingInstallment_service =
        await pendingInstallmentService(
          encrypt(JSON.stringify(formData), token)
        );
        ...
        if (response_getPayGateway_data.status) {
          ...
          const formDataPayment = {
            ...
            course_price: parseFloat(
              installment && installment?.emi_mrp
            ).toFixed(2),
            ...
            <div className="history_List col-sm-12 col-md-12 col-lg-12 mb-3 ">
              {myOrder &&
                myOrder.map((item, index) => {
                  return (
                    <div
                      className="card historyCard px-2 py-2 mb-2"
                      key={index}
                    >
                      <div class="row align-items-center">
                        {/* <tr className=""> */}
                        <div class="col-12 col-md-2 mb-2 mb-md-0 ">
                          <div className="purchaseThumbnail">
                            <img
                              loading="lazy"
                              className="img-fluid"
                              src={
                                item?.desc_header_image
                                  ? item.desc_header_image
                        ...
                        <div class="col-12 col-md-3 mb-2 mb-md-0">
                          ...
                          <p class="m-0 text-muted historyDate">
                            <span>Added:</span>{" "}
                            {formatDate(JSON.parse(item.purchase_date))}
                          </p>
                        </div>
                        ...
                        <div class="col-6 col-md-2 mb-2 mb-md-0">
                                ...
                                installments[item.subscription_code].map(
                                  (installment, idx) => (
                                    <div className="col-md-12 my-3 " key={idx}>
                                      ...
                                      <div className="card child_historyCard">
                                        <p className="m-0 purchaseStripe">
                                          Installment {idx + 1}
                                        </p>
                                        <table>
                                          <tr className="" key={idx}>
                                            <td className="">
                                              {installment.emi_status ===
                                              "Paid" ? (
                          ...
                          {/* <td className="" style={{ width: "135px" }}>
                            {installment?.emi_status === "Paid" ? (
                              <p className="m-0 paid">Paid</p>
                            ) : checkEMIStatus(installment?.modified) ==
                              "due" ? (
                              <p className="m-0 due">Due</p>
                            ) : checkEMIStatus(installment?.modified) ==
                              "Upcoming" ? (
                              ...
                              checkEMIStatus(installment?.modified) ==
                                "Overdue" && <p className="m-0 due">Overdue</p>
                            )}
                          </td> */}
